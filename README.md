...
Original Plugin by bxqm, forked by Guzram

[![pub package](https://img.shields.io/pub/v/sliding_sheet.svg)](https://pub.dartlang.org/packages/sliding_sheet)
[![GitHub Stars](https://img.shields.io/github/stars/idabgsram/sliding_sheet.svg?logo=github)](https://github.com/idabgsram/sliding_sheet)

A widget that can be dragged and scrolled in a single gesture and snapped to a list of extents.

<a href="https://github.com/idabgsram/sliding_sheet/blob/master/example/lib/main.dart">
  <img width="205px" alt="Example of a SlidingSheet" src="https://raw.githubusercontent.com/idabgsram/sliding_sheet/master/assets/example.gif"/>
</a>
...
If you like this package, consider supporting it by giving it a star on [GitHub](https://github.com/idabgsram/sliding_sheet) and a like on [pub.dev](https://pub.dev/packages/sliding_sheet) :heart:
...
#### Result:
<img width="205px" alt="Example" src="https://raw.githubusercontent.com/idabgsram/sliding_sheet/master/assets/usage_example.gif" href/>
...
```
#### Result:
<img width="205px" alt="Example" src="https://raw.githubusercontent.com/idabgsram/sliding_sheet/master/assets/usage_example_bottom_sheet.gif"/>
...
<p float="left">
  <img width="205px" alt="SnapPositioning.relativeToAvailableSpace with a snap of 0.5" src="https://raw.githubusercontent.com/idabgsram/sliding_sheet/master/assets/example_snapping_relativeToAvailableSpace.png"/>
  <img width="205px" alt="SnapPositioning.relativeToSheetHeight with a snap of 0.5" src="https://raw.githubusercontent.com/idabgsram/sliding_sheet/master/assets/example_snapping_relativeToSheetHeight.png"/>
  <img width="205px" alt="SnapPositioning.pixelOffset with a snap of 100" src="https://raw.githubusercontent.com/idabgsram/sliding_sheet/master/assets/example_snapping_pixelOffset.png"/>
</p>
...
```
#### Result:
<img width="205px" alt="Simple header/footer example" src="https://raw.githubusercontent.com/idabgsram/sliding_sheet/master/assets/example_header_footer.gif"/>
...
<img width="205px" alt="Example of Material Effects" src="https://raw.githubusercontent.com/idabgsram/sliding_sheet/master/assets/example_reflecting_changes.gif"/>